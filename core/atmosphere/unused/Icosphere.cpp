...
// ctor
///////////////////////////////////////////////////////////////////////////////
Icosphere::Icosphere(int sub, bool smooth) : radius(1.0f), subdivision(sub), smooth(smooth), interleavedStride(32)
{
    if(smooth)
        buildVerticesSmooth();
    else
...
// does not recommend to use this approach
// modify model matrix to change radius dynamically
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// refresh device buffer VAO/VBO/EBO
///////////////////////////////////////////////////////////////////////////////
void Icosphere::refreshBuffer()
{

    if(isBufferAllocated) { releaseBuffer(); }
    ...
    glBufferData(GL_ARRAY_BUFFER, interleavedVertices.size()*sizeof(float)*8, &interleavedVertices[0], GL_STATIC_DRAW);
    // fill EBO
    glGenBuffers(1, &ebo);
    glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ebo);
...
///////////////////////////////////////////////////////////////////////////////
// release device buffer VAO/VBO/EBO
///////////////////////////////////////////////////////////////////////////////
void Icosphere::releaseBuffer()
{
