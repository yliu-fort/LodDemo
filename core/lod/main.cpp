...
int main()
{
    ...
    // LOD color
    std::vector<glm::vec3> lodColor;
    lodColor.push_back(glm::vec3(1));
    lodColor.push_back(glm::vec3(0,1,0));
    lodColor.push_back(glm::vec3(1,0,0));
    lodColor.push_back(glm::vec3(0,0,1));
    lodColor.push_back(glm::vec3(1,1,0));
    lodColor.push_back(glm::vec3(0,1,1));
    lodColor.push_back(glm::vec3(1,0,1));
    ...
    while( !glfwWindowShouldClose( window ) )
    {
        ...
        camera.Position.y =camera.Position.y > 1.0f?camera.Position.y:1.0f;
        if(ticking)
            std::cout << "current global scale = " << camera.Position.y << "m\n";

        float globalScaling = camera.Position.y;
