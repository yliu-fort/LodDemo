...
unsigned int loadTexture(std::string path, GLenum texType=GL_RGB, GLenum dataType=GL_UNSIGNED_BYTE)
{
    ...
    if (data)
    {
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, texType, dataType, data);
